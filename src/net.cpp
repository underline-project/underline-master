...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Underline " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"192.168.1.68", "192.168.1.67"},
    {"173.82.255.122", "173.82.255.124"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Underline is probably already running."), addrBind.ToString().c_str());
        else
